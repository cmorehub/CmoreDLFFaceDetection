                    ...
                    if((faces != null) && (faces.length == 1)){
                        ...
                        if(((method == MANUALLY) && capturePressed) || (method == TIME)){
                            ...
                            for(int i = 0; i<faces.length; i++){
                                // 畫出綠框
                                MyMatOperation.drawRectangleAndLabelOnPreview(imgRgba, faces[i], String.valueOf(total), front_camera);
                            }
                            ...
                            for(int i = 0; i<faces.length; i++){
                                // 畫出綠框
                                MyMatOperation.drawRectangleOnPreview(imgRgba, faces[i], front_camera);
                            }
                        }
                    }
                }
