...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //addPreferencesFromResource(ch.zhaw.facerecognitionlibrary.R.xml.preferences);
        ...
        adb.setPositiveButton("確定", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                PreferenceManager.setDefaultValues(getApplicationContext(), R.xml.mysetting, true);

                Toast.makeText(getApplicationContext(), "已恢復成預設值", Toast.LENGTH_SHORT).show();
            }
        });
